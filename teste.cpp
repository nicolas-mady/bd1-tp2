...
int main() {
  int m = 6;
  std::vector<int> u = {1, 2, 5, 8, 10, 11, 15, 17, 20, 21, 25, 27, 29, 31};
  std::vector<std::string> v = {"1", "2", "5", "8", "10", "11", "15", "17", "20", "21", "25", "27", "29"};
  std::cout << v.size() << std::endl;
  std::vector<int> x;
  std::vector<std::string> w;
  w.assign(v.begin() + m, v.end());
  x.assign(u.begin() + m + 1, u.end());
  u.resize(m + 1);
  v.resize(m);

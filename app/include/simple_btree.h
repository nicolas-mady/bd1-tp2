...
public:
    SimpleBTree(const std::string &filename) : filename(filename), loaded(false) {}
...
private:
    ...
    // Funções de comparação específicas para cada tipo (implementadas nas especializações)
...
template <>
inline int SimpleBTree<IndicePrimarioEntry>::compare(const IndicePrimarioEntry &a, const IndicePrimarioEntry &b)
{
    return a.id - b.id;
}

template <>
inline bool SimpleBTree<IndicePrimarioEntry>::matches(const IndicePrimarioEntry &entry, const IndicePrimarioEntry &key)
{
...
template <>
inline int SimpleBTree<IndiceSecundarioEntry>::compare(const IndiceSecundarioEntry &a, const IndiceSecundarioEntry &b)
{
    return strcmp(a.titulo, b.titulo);
}

template <>
inline bool SimpleBTree<IndiceSecundarioEntry>::matches(const IndiceSecundarioEntry &entry, const IndiceSecundarioEntry &key)
{

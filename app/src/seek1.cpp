...
int main(int argc, char *argv[])
{
    ...
    std::cout << std::endl
              << "=== BUSCA NO ÍNDICE PRIMÁRIO ===" << std::endl;
    ...
    std::cout << "ID encontrado no índice - posição hash: " << result_entry.posicao_hash << std::endl;
    ...
    std::cout << "Blocos do índice primário: " << index_stats.total_blocos << std::endl;
    std::cout << "Tempo total de busca: " << duration.count() << " µs" << std::endl;
